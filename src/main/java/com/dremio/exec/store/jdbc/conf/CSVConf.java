...
@SourceType(value = "CSVARP", label = "CSV",uiConfig = "csv-layout.json")
public class CSVConf extends AbstractArpConf<CSVConf> {
  private static final String ARP_FILENAME = "arp/implementation/csv-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.csv.CSVDriver";
